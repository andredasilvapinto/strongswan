...
/**
 * Include a partial block to MAC by padding it with zero bytes
 */
...
/**
 * Include associated data with padding to MAC
 */
	...
	private_chapoly_aead_t *this, chunk_t key)
{
	...
	return this->drv->set_key(this->drv, "expand 32-byte k", key.ptr);
}
									...
									size_t key_size, size_t salt_size)
{
	...
	if (CHACHA_KEY_SIZE != 32 || salt_size != 0)
	{
		return NULL;
	}
